...
Original Contribution - Griatch, 2015
Modified by MaCorvalan, 2022
    * Replace "Contrib" with "AURPG"
    * Replaced "return f'/me whispers {message}'" with "return message",
...
to a game, common to many RP-centric games:
    ...
    - in-emote says, including seamless integration with language
        obscuration routine (such as AURPG/rplanguage.py)
...
def regex_tuple_from_key_alias(obj):
    ...
    being able to mix this AURPG with objects not using sdescs, but
...
class AURPGRPObject(DefaultObject):
    """
...
class AURPGRPCharacter(DefaultCharacter, AURPGRPObject):
    """
    ...
    def process_language(self, text, speaker, language, **kwargs):
        ...
        Notes:
            ...
            the evennia.AURPG.rplanguage module.
